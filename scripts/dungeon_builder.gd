	...
	match floor_num:
		0:
			return {
				...
				"floor_color": Color(0.55, 0.50, 0.40),
				"floor_roughness": 0.85,
				"wall_color": Color(0.60, 0.55, 0.45),
				"wall_roughness": 0.80,
				"accent_color": Color(0.70, 0.60, 0.45),
				"ambient_color": Color(0.75, 0.70, 0.60),
				"ambient_energy": 0.7,
				"fog_color": Color(0.45, 0.42, 0.38),
				"fog_density": 0.001,
				"light_color": Color(1.0, 0.92, 0.75),
				"light_energy": 1.5,
			}
		1:
			return {
				"name": "The Sift",
				"floor_color": Color(0.50, 0.45, 0.35),
				"floor_roughness": 0.85,
				"wall_color": Color(0.55, 0.50, 0.40),
				"wall_roughness": 0.80,
				"accent_color": Color(0.65, 0.55, 0.40),
				"ambient_color": Color(0.65, 0.60, 0.50),
				"ambient_energy": 0.65,
				"fog_color": Color(0.40, 0.38, 0.32),
				"fog_density": 0.002,
				"light_color": Color(1.0, 0.90, 0.65),
				"light_energy": 1.4,
			}
		2:
			return {
				"name": "The Spectacle",
				"floor_color": Color(0.55, 0.38, 0.22),
				"floor_roughness": 0.70,
				"wall_color": Color(0.65, 0.45, 0.25),
				"wall_roughness": 0.65,
				"accent_color": Color(0.95, 0.75, 0.30),
				"ambient_color": Color(0.85, 0.65, 0.35),
				"ambient_energy": 0.7,
				"fog_color": Color(0.50, 0.35, 0.18),
				"fog_density": 0.001,
				"light_color": Color(1.0, 0.85, 0.50),
				"light_energy": 1.6,
			}
		3:
			return {
				"name": "The Crush",
				"floor_color": Color(0.35, 0.25, 0.45),
				"floor_roughness": 0.60,
				"wall_color": Color(0.42, 0.30, 0.52),
				"wall_roughness": 0.55,
				"accent_color": Color(0.75, 0.40, 0.90),
				"ambient_color": Color(0.60, 0.35, 0.75),
				"ambient_energy": 0.6,
				"fog_color": Color(0.28, 0.18, 0.35),
				"fog_density": 0.003,
				"light_color": Color(0.85, 0.60, 1.0),
				"light_energy": 1.4,
			}
		_:
			...
			return {
				"name": "The Deep",
				"floor_color": Color(0.18, 0.22, 0.20),
				"floor_roughness": 0.40,
				"wall_color": Color(0.22, 0.28, 0.25),
				"wall_roughness": 0.35,
				"accent_color": Color(0.2, 1.0, 0.7),
				"ambient_color": Color(0.25, 0.50, 0.40),
				"ambient_energy": 0.5,
				"fog_color": Color(0.10, 0.18, 0.14),
				"fog_density": 0.005,
				"light_color": Color(0.4, 1.0, 0.7),
				"light_energy": 1.3,
			}
